...
/**
 * The {@link RemoteControllerSocket} is responsible for sending key codes to the
 * Samsung TV.
 *
 * @see <a
 ...
 */
public class RemoteControllerSocket implements RemoteController {

    private static final int CONNECTION_TIMEOUT = 500;

    private final Logger logger = LoggerFactory.getLogger(RemoteControllerSocket.class);
     ...
     */
    public RemoteControllerSocket(String host, int port, String appName, String uniqueId) {
        this.host = host;
        this.port = port;
